...
#############################  kwargs  ##########################
/data/puyuan/data_from_h/rft

DATA_PATH="/data/puyuan/data_from_h/rft/dataset/svkg_rule_image_text_resize8192_20250717_v2/train_val"
...
REWARD_PRETRAIN_PATHS='{"safety":"/data/puyuan/data_from_h/rft/reward_model_20250828/safe_orm/","value":"/data/puyuan/data_from_h/rft/reward_model_20250828/value_orm/","knowledge":"/data/puyuan/data_from_h/rft/reward_model_20250828/knowledge_orm/","normal":"/data/puyuan/data_from_h/rft/reward_model_20250828/knowledge_orm/","general":"/data/puyuan/data_from_h/rft/reward_model_20250828/knowledge_orm/"}'

# ====================================The following is only for debug====================================
# TODO: ONLY FOR DENUG
# REWARD_PRETRAIN_PATHS='{}'
# REWARD_PRETRAIN_PATHS='{"value":"/data/puyuan/data_from_h/rft/reward_model_20250828/value_orm/"}'
# REWARD_PRETRAIN_PATHS='{"safety":"/data/puyuan/data_from_h/rft/reward_model_20250828/safe_orm/","value":"/data/puyuan/data_from_h/rft/reward_model_20250828/value_orm/"}'

ENGINE_TP=1  # vLLM/SGLang, for 7b base model
PRETRAIN_PATH="/data/puyuan/data_from_h/rft/base_model_after_kg_20250905" # 在kg上训练后的qwen-vl 7b
...
torchrun --nnodes $NNODES --nproc-per-node $GPUS_PER_NODE --node_rank $NODE_RANK --master-port $MASTER_PORT --master-addr $MASTER_ADDR examples/safework_t1_runnable/train_colocate.py \
   ...
   2>&1 | tee "/data/puyuan/LightRFT/rft_logs/${NAME}/${NAME}_7b_1node_node${NODE_RANK}_$(date +%Y%m%d_%H%M%S).log"
