...
EXPERIMENT_NAME="lightrft-ursa8b-mathprm-eval-fix-verify"
...
MAX_SAMPLES=32  # exactly 1 rollout-step
...
export MASTER_PORT="${MASTER_PORT:-20194}"  # different port from misalign-fix smoke
